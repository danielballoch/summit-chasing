...
const handler = async (req, res) => {
    ...
    //check data
    const {billing, customerid, fName, lName, address, address2, city, state, zip, phone, email,country} = req.body
    console.log("Req.body: ", req.body)
    console.log("vars: ", billing, customerid, fName, lName, address, address2, city, state, zip, phone, email,country)
    if (customerid){
